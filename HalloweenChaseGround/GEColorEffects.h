...
#define lightCount 15  //Total # of lights on string (usually 50, 48, or 36)
...
#define COLOR_DKRED     COLOR(0x9,0,0)
...
#define COLOR_PURPLE     COLOR(0x5,0x0,0xc)
#define COLOR_LTPURPLE    COLOR(0x7,0x0,0xe)
...
class GEColorEffects
{
   public:
      ...
      void strobeGround(color_t,int*,int);
      void strobeToColor(color_t,color_t,color_t);
      ...
      void set_string_colors(color_t color1, color_t color2, color_t color3); //set string to random color per bulb
